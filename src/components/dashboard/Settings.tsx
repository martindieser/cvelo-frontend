...
const templates = [
  ...
  { id: "minimal", name: "Minimalista", description: "Enfocado 100% en el contenido." },
  { id: "classic", name: "Clásico", description: "Estructura tradicional para roles ejecutivos." },
  { id: "creative", name: "Creativo", description: "Diseño audaz para roles de diseño/marketing." },
];
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Card className="border-border shadow-sm rounded-2xl md:col-span-2">
          ...
          <CardContent className="space-y-4">
            <div className="max-w-md">
              <Select value={language} onValueChange={setLanguage}>
                ...
                <SelectContent className="rounded-xl">
                  <SelectItem value="auto">Automático (Detectar de la oferta)</SelectItem>
            ...
            <p className="text-[10px] text-muted-foreground italic">
              * El modo automático usará el mismo idioma en el que esté escrita la descripción del puesto.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-border shadow-sm rounded-2xl md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Arrastra para reordenar cómo aparecerán las secciones en tu currículum.</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="max-w-md">
              <Reorder.Group axis="y" values={sections} onReorder={setSections} className="space-y-2">
                {sections.map((section) => (
                  <Reorder.Item 
                    key={section.id} 
                    value={section}
                    className="bg-card border border-border rounded-xl p-4 flex items-center gap-4 cursor-grab active:cursor-grabbing shadow-sm hover:shadow-md transition-shadow"
                  >
